    ...
    ITelegramBotClient _botClient) : IJob
{
    ...
    public async Task Execute(IJobExecutionContext context)
    {
        ...
        var message = await _botClient.SendTextMessageAsync(rejectChannel, descText).ConfigureAwait(false);
        await _botClient.PinChatMessageAsync(rejectChannel, message.MessageId, true).ConfigureAwait(false);
    }
}
