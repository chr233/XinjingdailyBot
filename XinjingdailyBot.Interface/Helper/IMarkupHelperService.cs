...
namespace XinjingdailyBot.Interface.Helper
{
    public interface IMarkupHelperService
    {
        ...
        /// <returns></returns>
        InlineKeyboardMarkup? LinkToOriginPostKeyboard(OldPosts post);
        /// <summary>
        /// 跳转链接键盘
        /// </summary>
        ...
        /// <param name="post"></param>
        /// <returns></returns>
        InlineKeyboardMarkup QueryPostMenuKeyboard(Users dbUser, OldPosts post);
        /// <summary>
        /// 获取随机投稿键盘
        /// </summary>
        /// <returns></returns>
        ...
        /// </summary>
        /// <returns></returns>
        InlineKeyboardMarkup RandomPostMenuKeyboard(Users dbUser, OldPosts post, int tagId, string postType);
        /// <summary>
        /// 审核键盘A(选择稿件Tag)
        /// </summary>
        /// <param name="tagNum"></param>
