        ...
        internal static async Task AddBuildInValues()
        {
            ...
            List<Groups> rights = new()
            {
                new()
                {
                    Id = 1,
                    Name = "普通用户",
                    DefaultRight = UserRights.SendPost|UserRights.NormalCmd
                },
                new()
                {
                    Id = 2,
                    Name = "审核员",
                    DefaultRight = UserRights.SendPost|UserRights.ReviewPost|UserRights.NormalCmd
                },
                new()
                {
                    Id = 3,
                    Name = "发布员",
                    DefaultRight = UserRights.SendPost|UserRights.DirectPost|UserRights.NormalCmd
                },
                new()
                {
                    Id = 4,
                    Name = "狗管理",
                    DefaultRight = UserRights.SendPost|UserRights.ReviewPost|UserRights.DirectPost|UserRights.NormalCmd|UserRights.AdminCmd
                },
                new()
                {
                    Id = 5,
                    Name = "超级狗管理",
                    DefaultRight = UserRights.SendPost|UserRights.ReviewPost|UserRights.DirectPost|UserRights.NormalCmd|UserRights.AdminCmd|UserRights.SuperCmd
                },
                new()
                {
                    Id = 6,
                    Name = "封禁用户",
                    DefaultRight = UserRights.None
                },
            };
