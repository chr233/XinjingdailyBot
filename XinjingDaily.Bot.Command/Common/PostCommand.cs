    ...
    IOptions<AppSettings> _options)
{
    ...
    {
        var sb = new StringBuilder();
        sb.AppendLine($"程序版本: <code>{BuildInfo.Version}</code> <code>{BuildInfo.Variant}</code>");
        sb.AppendLine(string.Format("获取开源程序: {0}", _textService.HtmlLink("https://github.com/chr233/XinjingdailyBot/", "XinjingDaily.Bot")));
        sb.AppendLine(string.Format("爱发电: {0}", _textService.HtmlLink("https://afdian.com/a/ylnflp", "@ylnflp")));
        sb.AppendLine(string.Format("欢迎订阅心惊报: {0}", _textService.HtmlLink("https://t.me/xinjingdaily", "@xinjingdaily")));
